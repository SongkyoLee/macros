    ...
    const char *embed_input_file = "/sphenix/data/data02/review_2017-08-02/sHijing/fm_0-4.list")
{
  ...
  gSystem->Load("libKyoTreeMaker.so");
...
*/
  ...
  KyoTreeMaker *tm = new KyoTreeMaker( outputFile ,false,false,false,false,true,true,false);
  //KyoTreeMaker *tm = new KyoTreeMaker( outputFile ,true,true,true,true,true,true,true);
