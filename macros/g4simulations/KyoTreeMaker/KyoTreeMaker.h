...
class KyoTreeMaker: public SubsysReco
{
 ...
 public:
  ...
  KyoTreeMaker(const std::string &name, bool fill_g4particle_tree=true, bool fill_track_tree=true, bool fill_tower_tree=true, bool fill_cluster_tree=true, bool fill_truthjet4_tree=true, bool fill_towerjet4_tree=true, bool fill_bhhit_tree=true);
