...
class KyoTreeMaker: public SubsysReco
{
 ...
 private:
  ...
  ///////////////////////////////////////////////////////////////////////// 
  int _b_cl_cemc_n;
  std::vector<float> _b_cl_cemc_e;
  std::vector<float> _b_cl_cemc_p;
  std::vector<float> _b_cl_cemc_pt;
  std::vector<float> _b_cl_cemc_eta;
  std::vector<float> _b_cl_cemc_phi;
  std::vector<int> _b_cl_cemc_ntwr;
  std::vector<float> _b_cl_cemc_prob; //only for CEMC
  std::vector<float> _b_cl_cemc_chi2;
  int _b_cl_ihcal_n;
  std::vector<float> _b_cl_ihcal_e;
  std::vector<float> _b_cl_ihcal_p;
  std::vector<float> _b_cl_ihcal_pt;
  std::vector<float> _b_cl_ihcal_eta;
  std::vector<float> _b_cl_ihcal_phi;
  std::vector<int> _b_cl_ihcal_ntwr;
  int _b_cl_ohcal_n;
  std::vector<float> _b_cl_ohcal_e;
  std::vector<float> _b_cl_ohcal_p;
  std::vector<float> _b_cl_ohcal_pt;
  std::vector<float> _b_cl_ohcal_eta;
  std::vector<float> _b_cl_ohcal_phi;
  std::vector<int> _b_cl_ohcal_ntwr;
